    ...
    <div className="min-h-screen bg-ravan-black text-white flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10">
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-4 text-center">Contact Us</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="glass-card p-8 rounded-3xl border border-white/10 bg-gradient-to-b from-ravan-purple/20 to-transparent backdrop-blur-md hover:translate-y-[-5px] transition-transform">
              ...
              <ul className="space-y-5">
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Early Adopters</h3>
                  <a href="mailto:adopt@ravanos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    adopt@ravanos.com
                  </a>
                </li>
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Investor Relations</h3>
                  <a href="mailto:invest@ravanos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    invest@ravanos.com
                  </a>
                </li>
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Careers</h3>
                  <a href="mailto:career@ravanos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    career@ravanos.com
                  </a>
                </li>
              </ul>
            ...
            <div className="glass-card p-8 rounded-3xl border border-white/10 bg-gradient-to-b from-ravan-blue/20 to-transparent backdrop-blur-md hover:translate-y-[-5px] transition-transform">
              ...
              <ul className="space-y-5">
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Sri Lanka Support</h3>
                  <a href="mailto:sl@ravanaos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    sl@ravanaos.com
                  </a>
                </li>
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Canada Support</h3>
                  <a href="mailto:ca@ravanaos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    ca@ravanaos.com
                  </a>
                </li>
                <li>
                  <h3 className="text-white/90 text-lg font-medium mb-1">Germany Support</h3>
                  <a href="mailto:de@ravanaos.com" className="text-ravan-accent hover:text-ravan-accent-light">
                    de@ravanaos.com
                  </a>
                </li>
              </ul>
          ...
          <div className="glass-card p-8 rounded-3xl border border-white/10 bg-gradient-to-b from-ravan-accent/20 to-transparent backdrop-blur-md mb-12">
            ...
            <div>
              <h3 className="text-white/90 text-lg font-medium mb-1">Parent Company</h3>
              <p className="mb-2">Ravana Industries Inc.</p>
              <a href="https://ravanaindustries.com" target="_blank" rel="noopener noreferrer" className="text-ravan-accent hover:text-ravan-accent-light">
