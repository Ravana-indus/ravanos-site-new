  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "py-3 md:py-4 bg-ravan-black/90 backdrop-blur-md shadow-md"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <div className="flex space-x-6">
            ...
            <Link to="/it-support" className="nav-link">
              IT Support
            </Link>
      ...
      {/* Mobile Navigation */}
      <div
        className={`md:hidden fixed inset-0 top-[57px] bg-ravan-black z-[100] transition-all duration-300 ${
